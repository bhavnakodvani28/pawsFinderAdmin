<%-- 
    Document   : updateAdoptionStatus
    Created on : Oct 19, 2020, 1:50:15 PM
    Author     : Krina
--%>
...
<html class="no-js" lang="en">
    ...
    <title>Update Adoption Status - PawsFinder</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Adoption Status Modification</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="adminHome.jsp">Home</a></li>
                                <li><a>Manage Dog Details</a></li>
                                <li><span>Update Adoption Status</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${dog != null}">
                                            <form action="DogServlet" method="POST">
                                                <input type="hidden" value="statusUpdate" name="action">
                                        </c:if>
                                        <c:if test="${dog == null}">
                                            <form action="DogServlet" method="POST" enctype="multipart/form-data">
						...
						<c:if test="${dog == null}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<c:out value='${dog.dogName}' />" name="dogName" style="text-transform:uppercase" readonly>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-form-label">Breed</label>
                                            <input class="form-control" type="text" value="<c:out value='${dog.breed}' />" name="breed" style="text-transform:uppercase" readonly>
                                        </div>
                                        
                                        <b class="text-muted mb-3 d-block">Adoption Status</b>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" checked id="yes" name="adoptionStatus" class="custom-control-input" value="YES" ${dog.adoptionStatus=='YES'?'checked':''}>
                                                <label class="custom-control-label" for="yes">Yes</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="no" name="adoptionStatus" class="custom-control-input" value="NO" ${dog.adoptionStatus=='NO'?'checked':''}>
                                                <label class="custom-control-label" for="no">No</label>
                                            </div>
                                                
                                        <div class="form-group">
                                            <label class="col-form-label">Adoption Amount</label>
                                            <input class="form-control" type="text" value="<c:out value='${dog.price}' />" name="price" readonly>
                                        </div>

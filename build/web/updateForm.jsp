<%-- 
    Document   : updateForm
    Created on : Oct 18, 2020, 6:04:46 PM
    Author     : Krina
--%>
...
<html class="no-js" lang="en">
    ...
    <title>Update Dog Details - PawsFinder</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Dog Details Modification</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="adminHome.jsp">Home</a></li>
                                <li><a>Manage Dog Details</a></li>
                                <li><span>Update Dog Details</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-ml-12">
						...
						<c:if test="${dog == null}">
                                        ...
                                        <b class="text-muted mb-3 d-block">Adoption Status</b>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="no" name="adoptionStatus" class="custom-control-input" value="YES" ${dog.adoptionStatus=='NO'?'checked':''}>

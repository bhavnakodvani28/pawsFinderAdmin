<%-- 
    Document   : updateImageForm
    Created on : Oct 19, 2020, 5:15:23 PM
    Author     : Krina
--%>
...
<html class="no-js" lang="en">
    ...
    <title>Upload Dog Images - PawsFinder</title>
                            ...
                            <div class="col-12">
                                <div class="card mt-5">
                                    <div class="card-body">
                                        ...
                                        %>
                                        <form action="UploadImageServlet?dogID=<%=dogID%>"  method="POST" enctype="multipart/form-data" name="form1" id="form1">
                                            ...
                                            <div class="input-group-append">
                                                <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="submit">Upload</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
